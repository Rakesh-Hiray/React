      ...
      <div className="container px-5 py-10 lg:w-5/6 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/4 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 md:ml-auto w-full mt-8 md:mt-0 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed/v1/place?q=Vithal+Mandir+Bavdhan,+Lantana+Gardens,+Bavdhan,+Pune,+Maharashtra,+India&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
          />
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-indigo-400 leading-relaxed">
                hirayrb2015@gmail.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">8208931250</p>
            </div>
          </div>
        </div>
        <form
